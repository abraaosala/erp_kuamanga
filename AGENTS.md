...
### RH (Recursos Humanos)
- Estado actual: **8 submódulos implementados** (CRUD completo)
  - Departamentos, Cargos, Funcionários, Contratos, Assiduidade, Escalas, Banco de Horas, **Vínculo Escala↔Funcionário**
- 7 áreas pendentes: Folha Salarial, Férias, Benefícios, Recrutamento, Avaliação, Portal do Colaborador, Relatórios
- Docs de tracking: `docs/modules/rh.md`
- **REGRA: sempre que houver mudança no código do módulo RH, actualizar o `docs/modules/rh.md`**
...
- Pest ^5 operacional: `php console test` — 9 testes passando (`tests/Modules/Rh/EmployeeScheduleTest.php`); suporta filtro (`php console test "prevents duplicate"`); `composer test` funciona
...
- Nenhum linter/formatter configurado
...
- `php console migrate|rollback|migrate:status`
- `php console db:seed`
- `php console make:controller|model|repository|service|view|migration`
- `php console serve`
