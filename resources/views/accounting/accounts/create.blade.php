...
<div class="container mx-auto px-6 py-8">
    <div class="flex items-center gap-4 mb-8">
        ...
        <h3 class="text-gray-700 dark:text-gray-200 text-3xl font-semibold">Nova Conta (PGC Angola)</h3>
    </div>
    ...
    <div class="max-w-4xl bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <form action="/accounting/accounts" method="POST" class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Código -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Código da Conta</label>
                    <input type="text" name="code" required placeholder="Ex: 11.2"
                ...
                <div>
                    ...
                    <input type="text" name="name" required placeholder="Ex: Banco BFA AKZ"
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all outline-none">
                </div>
                ...
                <div>
                    ...
                    <select name="type" required
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all outline-none">
                        <option value="asset">Ativo (Devedora)</option>
                        <option value="liability">Passivo (Credora)</option>
                        <option value="equity">Capital Próprio</option>
                        <option value="revenue">Proveito / Rendimento</option>
                        <option value="expense">Custo / Gasto</option>
                    </select>
                </div>
                ...
                <div class="flex items-center gap-3">
                    <input type="checkbox" name="is_analytic" value="1" id="is_analytic"
