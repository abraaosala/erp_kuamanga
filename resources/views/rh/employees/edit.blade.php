...
<div class="max-w-2xl mx-auto">
    ...
    <form method="POST" action="/rh/employees/{{ $employee->id }}/update" class="glass-card rounded-2xl p-6 space-y-6">
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" required class="form-input" value="{{ $employee->name }}" placeholder="Nome do funcionário">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" class="form-input" value="{{ $employee->phone }}" placeholder="+244 900 000 000">
                </div>
                <div>
