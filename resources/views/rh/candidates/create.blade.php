...
@section('title', 'Registar Candidato')
@section('page-title', 'Recrutamento')
@section('page-subtitle', 'Registar novo candidato')
...
<div class="max-w-2xl mx-auto">
    ...
    <form method="POST" action="/rh/candidates" class="glass-card rounded-2xl p-6 space-y-6">
        <div>
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <input type="text" name="name" required maxlength="150" class="form-input" placeholder="Ex: Maria João">
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-semibold mb-1.5" style="color: var(--text-muted)">Email <span class="text-red-400">*</span></label>
                        <input type="email" name="email" required maxlength="190" class="form-input" placeholder="candidato@email.com">
                    </div>
                    <div>
                        <label class="block text-xs font-semibold mb-1.5" style="color: var(--text-muted)">Telefone</label>
                        <input type="text" name="phone" maxlength="30" class="form-input" placeholder="+244 9XX XXX XXX">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                ...
                <div>
                    ...
                    <textarea name="notes" class="form-input" rows="3" placeholder="Observações iniciais sobre o candidato"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center gap-3 pt-4 border-t" style="border-color: var(--border-color)">
            ...
            <a href="/rh/candidates" class="btn-secondary">Cancelar</a>
        </div>
    </form>
</div>
@endsection