...
<a href="/rh/leaves" class="block py-1.5 text-xs font-medium transition-colors @if(request()->is('rh/leaves*')) text-violet-300 @else text-indigo-300/50 hover:text-indigo-300 @endif">Férias</a>
                        <a href="/rh/benefits" class="block py-1.5 text-xs font-medium transition-colors @if(request()->is('rh/benefits*')) text-violet-300 @else text-indigo-300/50 hover:text-indigo-300 @endif">Benefícios</a>
                        <a href="/rh/job-openings" class="block py-1.5 text-xs font-medium transition-colors @if(request()->is('rh/job-openings*')) text-violet-300 @else text-indigo-300/50 hover:text-indigo-300 @endif">Vagas</a>
                        <a href="/rh/candidates" class="block py-1.5 text-xs font-medium transition-colors @if(request()->is('rh/candidates*')) text-violet-300 @else text-indigo-300/50 hover:text-indigo-300 @endif">Candidatos</a>
